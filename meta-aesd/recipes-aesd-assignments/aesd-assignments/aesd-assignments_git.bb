...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-shreyan-collab;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
SRCREV = "397c567b09daa5638fff28d9f501dd9f202a6299"
...
do_install () {
	...
	install -d ${D}${bindir}
	#copying the aesdsocket executable from server directory to target directory 
	install -m 0755 ${S}/aesdsocket ${D}${bindir}/
	install -d ${D}${sysconfdir}/init.d
	#installing aesd-start-stop-application
